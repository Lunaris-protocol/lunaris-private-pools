...
struct TransferFromProof {
    ProofPoints proofPoints;
    uint256[40] publicSignals; // Extended to include allowance data
}

struct TransferFromInputs {
    EGCT providedBalance;
    EGCT providedAllowance;
    EGCT senderEncryptedAmount;
    EGCT receiverEncryptedAmount;
    EGCT newAllowanceAmount;
    uint256[7] amountPCT;
}
