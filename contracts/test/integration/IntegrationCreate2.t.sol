...
contract IntegrationDeploy is Test {
  ...
  //////////////////////////////////////////////////////////////*/
    ...
    function setUp() public {
        ...
        _chains.push(
            ChainConfig(11_155_111, "sepolia", "ETH", _TOKEN, "SYMBOL")
        );
    ...
    function _deployContractsForChain(ChainConfig memory _chain) private {
        ...
        // Deploy pools
        _contracts[_chain.id].nativePool = _deployNativePool(
            _entrypoint,
            _withdrawalVerifier,
            _commitmentVerifier
        );
        _contracts[_chain.id].tokenPool = _deployTokenPool(
            _entrypoint,
            _withdrawalVerifier,
            _commitmentVerifier,
            _chain.token
    ...
    function _deployEntrypoint() private returns (address) {
        ...
        address _impl = _CREATEX.deployCreate2(
            DeployLib.salt(_DEPLOYER, DeployLib.ENTRYPOINT_IMPL_SALT),
    ...
    function _verifyAddressesMatch() private view {
        assertTrue(
            _contracts[1].commitmentVerifier ==
                _contracts[11_155_111].commitmentVerifier &&
                _contracts[11_155_111].commitmentVerifier ==
                _contracts[100].commitmentVerifier,
            "Commitment verifier addresses don't match"
        );

        assertTrue(
            _contracts[1].withdrawalVerifier ==
                _contracts[11_155_111].withdrawalVerifier &&
                _contracts[11_155_111].withdrawalVerifier ==
                _contracts[100].withdrawalVerifier,
